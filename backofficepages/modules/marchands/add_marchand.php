	...
	function ProposeFichier($UploadingFile)
{
	...
	if(isset($_POST['ajouter']))
  {
	...
	$sql='insert into marchands (marchand,logo,presentation,fichier,url,responsable,responsable_email,responsable_mobile,tel,email,reduction,adresse,site,id_ville,id_cat,message) 
			values 
		  ("'.$_POST['marchand'].'","'.$uploadlogo.'","'.$_POST['presentation'].'","'.$uploadfile.'","'.$_POST['url'].'","'.$_POST['responsable'].'","'.$_POST['responsable_email'].'","'.$_POST['responsable_mobile'].'","'.$_POST['tel'].'","'.$_POST['email'].'","'.$_POST['reduction'].'","'.$_POST['adresse'].'","'.$_POST['site'].'","'.$_POST['ville'].'","'.$_POST['cat'].'","'.$_POST['message'].'")';
